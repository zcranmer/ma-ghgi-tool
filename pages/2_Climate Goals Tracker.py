...
#st.markdown('<span style="font-size: 16px;">Some text can go here...</span>', unsafe_allow_html=True)
...
st.markdown('<span style="font-size: 16px;">The table below provides key data for the three measures at the \
...
html_str_evs = f"""
    ...
    <p class="a">In {locality} there are currently {locality_numbers[0]:,} EVs (including PHEVs). \
        ...
        Alternatively, 17% of all vehicles in {locality} is {pct_2030_evs:,}. \
        </p>
    """
...
html_str_hps = f"""
    <style> p.a {{font: 16px; }}</style>
    <p class="a">In {locality} there are currently {locality_numbers[1]:,} heat pumps installed. \
        ...
        Alternatively, 16% of all households in {locality} is {pct_2030_hps:,}. \
        </p>
    """
