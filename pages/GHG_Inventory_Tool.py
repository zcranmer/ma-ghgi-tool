...
with tab3:
    ...
    households = dataset.loc[(dataset['Municipality']==municipality)&(dataset['Year']==2023),'Total Heating Fuel Households'].astype('int').item()
    ...
    st.markdown('Note: Building emissions do not factor in renewable energy purchased through community aggregation programs. \
